...
public class RBTree {
	...
	public int insert(int k, String v) {
		...
		// Insert: Case 1b: zג€™s uncle w is red, z is a left child
		// Insert: Case 2:  zג€™s uncle w is black, z is a right child
		// Insert: Case 3:  zג€™s uncle w is black, z is a left child
		/* Abstract data type code:
		 * 	Insert as RED (always leaf)
		 * 	Too much RED is extra weight ג€“ must be reduced
		 * 		If imbalanced with brother ג€“ solve by re-balancing
		 * 		Else ג€“ push problem upwards
		 */
